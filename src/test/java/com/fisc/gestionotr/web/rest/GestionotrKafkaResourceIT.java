...
import com.fisc.gestionotr.GestionotrApp;
...
@SpringBootTest(classes = GestionotrApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class GestionotrKafkaResourceIT {
    ...
    @Autowired
    private GestionotrKafkaProducer producer;

    @Autowired
    private GestionotrKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        GestionotrKafkaResource kafkaResource = new GestionotrKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/gestionotr-kafka/publish?message=test"))
